...
def mainGame():
    ...
    playerFlapAccv_2 = -5 # velocity while flapping
    ...
    while True:
        ...
        crashTest_2 = isCollide_2(playerx_2, playery_2, upperPipes_2, lowerPipes_2) # This function will return true if the player is crashed
        ...
        if playery_2 < pipeHeight_2 + pipe_2['y'] \
           ...
           and playerx_2 < pipe_2['x'] + pipeWidth_2:
            if not crashTest_2:
                playery_2 = max(old_playery_2 + playerVelY_2, pipe_2['y']+ pipeHeight_2, pipe_2['y']+ pipeHeight_2 + playerVelY_2)
